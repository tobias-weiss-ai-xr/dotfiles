...
map <silent><F6> :w<cr>:! clear<cr>
            \ :call VimuxSetRunner(1)<cr>
            \ :call VimuxInterruptRunner()<cr>
            \ :call VimuxRunCommand("python3 -m pudb.run " . expand("%"))<cr>
...
if g:hostname == "ThinkPad.local.tobias-weiss.org"
    noremap <silent><F5> :w<cr>
                ...
                \ :call VimuxSetRunner(2)<cr>
                \ :call VimuxRunCommand("clear")<cr>
                \ :call VimuxRunCommand("python3.7 -m pytest")<cr>
    map <silent><F6> :w<cr>:! clear<cr>
                \ :call VimuxSetRunner(1)<cr>
                \ :call VimuxInterruptRunner()<cr>
                \ :call VimuxRunCommand("python3.7 -m pudb.run " . expand("%"))<cr>
    noremap <silent><leader>ll :w<cr>
                \ :call VimuxSetRunner(1)<cr>
                \ :call VimuxInterruptRunner()<cr>
                \ :call VimuxRunCommand("clear")<cr>
